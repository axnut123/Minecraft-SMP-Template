...
Ranks.getLandPermission = (player, permission) => {
  ...
  if (result == undefined) result = Config.Ranks.defaultLandPermission[permission] ?? false
  return result
}
...
export const PermissionValueType = {
  boolean: 0,
  number: 1,
  string: 2
}
...
Ranks.landPermissionList = {
  "land.claim": ["Land Claim Command", PermissionValueType.boolean],
  "land.claim_limit": ["Land Claim Limit", PermissionValueType.number],
  "land.unclaim": ["Land Unclaim Command", PermissionValueType.boolean],
  "land.invite": ["Land Invite Command", PermissionValueType.boolean],
  "land.kick": ["Land Kick Command", PermissionValueType.boolean],
  "land.transferOwnership": ["Land Transfer Ownership Command", PermissionValueType.boolean],
  "land.setting": ["Land Setting Command", PermissionValueType.boolean],
}
